...
var dataLoaded = function (data) {
	...
	groupHtml = '';
	groupHtml += template.render('groupTpl', {'name': '用戶組', 'value': data.Variables.space.group.grouptitle});
	if (data.Variables.space.admingroup.grouptitle) {
		groupHtml += template.render('groupTpl', {'name': '管理組', 'value': data.Variables.space.admingroup.grouptitle});
	}
	groupHtml += template.render('groupTpl', {'name': '註冊時間', 'value': data.Variables.space.regdate});
