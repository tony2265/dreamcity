function drop() {
	...
	function loadingFooter() {
		if (loadb) {
			...
			setTimeout(function () {
				now = new Date();
				var newli = '<li>' + now.getHours() + ' : ' + now.getMinutes() + ' : ' + now.getSeconds() + '&nbsp;&nbsp;加載的新內容</li><li>' + now.getHours() + ' : ' + now.getMinutes() + ' : ' + now.getSeconds() + '&nbsp;&nbsp;加載的新內容</li><li>' + now.getHours() + ' : ' + now.getMinutes() + ' : ' + now.getSeconds() + '&nbsp;&nbsp;加載的新內容</li>';
