...
$lang = array (
  ...
  'plugins_install_succeed' => '插件成功安裝！<br />為了正常使用此插件，您可能還需要上傳或修改相應的文件或模板，詳情請查看本插件的安裝說明<br /><br /><a href="https://addon.dismall.com?view=plugins">點擊這裡返回應用中心</a><br />',
  'plugin_file_error' => '插件文件缺失',
  'plugins_edit_identifier_invalid' => '您輸入的唯一標識符不合法或與現有插件重複',
  'plugins_upgrade_succeed' => '插件成功更新到 {toversion}<br /><br /><a href="https://addon.dismall.com?view=plugins">點擊這裡返回應用中心</a><br />',
  ...
  'plugins_config_upgrade_missed' => '此插件已更新到最新版本</h4><br /><a href="https://addon.dismall.com?view=plugins" class="lightlink">點擊這裡進入應用中心</a><br /><br /><h4>',
  'plugins_config_upgrade_new' => '此插件已更新到最新版本<br />但是發現此插件在應用中心存在新版本 {newver}，是否需要升級？</h4><br /><a href="https://addon.dismall.com?@{addonid}" class="lightlink">升級此插件</a> &nbsp;&nbsp; <a href="{ADMINSCRIPT}?action=plugins" class="lightlink">暫不升級</a><h4>',
  ...
  'styles_install_succeed' => '界面方案安裝完成<br /><br /><a href="https://addon.dismall.com?view=templates">點擊這裡返回應用中心</a><br />',
